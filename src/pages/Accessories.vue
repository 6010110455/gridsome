<template>
  <Layout>
    <div class="flex rounded-lg space-x-2 ">
      ...
      <g-link to="/accessories/"  class="text-xl text-white w-full text-center bg-gray-600 p-3 rounded-lg ring-blue-500 ring-4">
...
<page-query>
  ...
  {
    gcms{
      category(where: {id: "ckdu46rsw0gye0156pt4ufp50"}) {
        id
        name
        products {
          images {
